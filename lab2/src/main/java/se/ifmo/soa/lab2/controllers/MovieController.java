package se.ifmo.soa.lab2.controllers;
...
import se.ifmo.soa.lab2.exceptions.HttpRequestNotValidException;
import se.ifmo.soa.lab2.exceptions.RestfulException;
import se.ifmo.soa.lab2.mappers.MovieMapper;
import se.ifmo.soa.lab2.repositories.FilterParams;
import se.ifmo.soa.lab2.repositories.MovieRepository;
import se.ifmo.soa.lab2.repositories.SpecificationBuilder;
...
public class MovieController {
  ...
  public PageResult<MovieDto> getAll(
    ...
    try {
      ...
      return PageResult.fromPage(movies, movieMapper::mapDtoFromEntity);
